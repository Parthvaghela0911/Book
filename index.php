    ...
    <div class="wrap">
        <div class="content-top">
            <div class="listview_1_of_3 images_1_of_3">
                ...
                <?php
                $qry3 = mysqli_query($con, "SELECT * FROM tbl_news WHERE news_date > CURDATE() LIMIT 5");
                ...
                <div class="content-left">
                    ...
                    <div class="text list_1_of_2">
                        <div class="extra-wrap">
                            <span style="color:#000;" class="data"><strong><?php echo $n['name'];?></strong></span><br>
                            <span style="color:#000;" class="data"><strong>Cast: <?php echo $n['cast'];?></strong></span><br>
